...
---
```{r setup, include=FALSE} Sys.setlocale("LC_TIME", "C")
```
...
<a href="https://www.parisschoolofeconomics.eu/personnes/carine-staropoli/">Carine Staropoli</a>. I'm also a Research Fellow for the
...
<div>
Last update: `r format(Sys.Date(), " %B %Y")`
</div>
</div>
